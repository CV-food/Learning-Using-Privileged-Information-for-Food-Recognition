...
def create_labels(root_path):
    ...
    val_label = build_labels(root_path,val_data_path,'val')
    test_label = build_labels(root_path,test_data_path,'test')
...
# train_label=  matio.loadmat(root_path+ 'train_label.mat')['train_label'][0]
# print(train_label[65733],train_label[65734])